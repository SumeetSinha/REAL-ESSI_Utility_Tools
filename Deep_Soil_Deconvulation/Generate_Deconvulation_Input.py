...
###########################################################################################################################
#                                                                                                                         #
#  Generate_Deconvulation_Input :: Generate Deconvulation Input for Deep Soil                                             #
#  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -                                      #
#                                                                                                                         #
#                                                                                                                         #
...
# Deconvolved - northridge - layer 1
...
print "#################################################################################"
print "#                                                                               #"
print "#  Generate_Deconvulation_Input :: Generate Deconvulation Input for Deep Soil   #"
...
for line in DataFile.readlines():
	...
	if (If_Float):
		if (NumTokens>=5):
			...
			Z_Elevation_Dic[Elevation] = "Deconvolved - " + RefMotionName + " - layer "+str(LayerNo)+".txt";
			Elevation = Elevation - float(ParList[0]);
		else:
			print "\nWARNING:: [Generate_Deconvulation_Input]:: Error in Line no " + str(LineNo) + " Skipping it !! \n " ; 	

Z_Elevation_Vec.append(Elevation);
Z_Elevation_Dic[Elevation] = "Deconvolved - " + RefMotionName + ".txt";
DataFile.close();

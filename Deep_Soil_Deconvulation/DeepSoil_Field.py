...
def getField (x,y,z,DRM_Time):
	...
	NumTimeSteps = DRM_Time.shape[0]; # variables accessible to user  
	acceleration = np.zeros([3, NumTimeSteps],dtype=np.double); # variables accessible to user  
	displacement = np.ones([3, NumTimeSteps],dtype=np.double); # variables accessible to user  
